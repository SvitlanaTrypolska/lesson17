...
function watch() {
  ...
  gulp.watch(paths.fonts.src, fonts); // Watch fonts  files
  gulp.watch(paths.pages.src, pages).on('change', browserSync.reload); // Watch HTML files
}

// Define complex tasks
const build = gulp.series(gulp.parallel(styles, scripts, images, sprite, fonts, pages)); // Build task for production
